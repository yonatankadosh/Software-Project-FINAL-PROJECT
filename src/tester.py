...
def initialize_H(W: np.ndarray, k: int, set_seed=False):
    ...
    # Initialize H matrix similar to your implementation
...
def test_symnmf_lib():
    ...
    W = np.array(symnmf.compute_normalized_similarity_matrix(A, D))
    ...
    final_H = np.array(symnmf.symnmf(W, initial_H, 300, 1e-4))
